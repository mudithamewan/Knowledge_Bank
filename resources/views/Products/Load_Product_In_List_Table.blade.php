    ...
    <table id="result_table" class="table table-sm">
        <thead>
            <tr>
                ...
                <th style="white-space: nowrap;">UNIT PURCHASE AMOUNT <span class="filter-icon"><i class="bx bx-filter"></i></span></th>
                <th style="white-space: nowrap;">UNIT SELLING AMOUNT <span class="filter-icon"><i class="bx bx-filter"></i></span></th>
                <th style="white-space: nowrap;">TO <span class="filter-icon"><i class="bx bx-filter"></i></span></th>
                ...
                <th style="white-space: nowrap;">IN TYPE <span class="filter-icon"><i class="bx bx-filter"></i></span></th>
    ...
    function get_table_data() {
        ...
        var table = $('#result_table').DataTable({
            ...
            ajax: {
                ...
                url: "{{url('/')}}/load_in_list_by_product_table_data",
                data: {
                    FROM_DATE: '{{$FROM_DATE}}',
                    TO_DATE: '{{$TO_DATE}}',
