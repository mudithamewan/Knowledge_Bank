...
<body data-sidebar="dark">
        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Category Manager</h4>

                                <button type="button" class="btn btn-primary waves-effect btn-label waves-light" data-bs-toggle="modal" data-bs-target="#add_new_category_modal">
                                    <i class="bx bx-plus label-icon"></i> NEW CATEGORY
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Add New Modal -->
                    <div class="modal fade" id="add_new_category_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
                        <div class="modal-dialog modal-lg modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="NEW_CATEGORY_CREATE_FORM">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 mt-3">
                                                <div id="NEW_CATEGORY_CREATE_FORM_BTN">
                    ...
                    <div class="card mt-3">
                        <div class="card-header bg-transparent border-bottom">
                            <div class="d-flex flex-wrap align-items-start">
                                <div class="me-2">
                                    <h5 class="card-title mt-2 text-primary">CATEGORY DETAILS</h5>
                                </div>
                                <div class="ms-auto">
                                    <form action="{{url('/')}}/get_category_result_table" method="post">
                                        @csrf
    ...
    <!-- Edit Modal -->
    <div class="modal fade" id="edit_category_modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div id="LOAD_EDIT_CATEGORY_VIEW"></div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Close</button>
                </div>
    ...
    <script>
        function get_table_data() {
            ...
            var table = $('#result_table').DataTable({
                ...
                ajax: {
                    ...
                    url: "{{url('/')}}/get_category_result_table",
                    data: {
                        DOWNLOAD: 'NO'
                    },
                    dataSrc: "data"
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: d => `<button class="btn btn-primary btn-sm"
                                ...
                                onclick="ajax_action(
                                    '{{ url('/') }}/load_edit_category_view',
                                    'LOAD_EDIT_CATEGORY',
                                    JSON.stringify({ CATE_ID: ${d} }),
                                    '{{ csrf_token() }}'
                                )">EDIT</button>`
                    }
                ],
                initComplete: function() {
                    ...
                    $('#result_table thead th').each(function(i) {
                        // skip ACTION col (index 5)
                        if (i === 5) return;

                        var $th = $(this);
                        var dropdown = $('<div class="dropdown-filter"></div>');

                        // attach dropdown to body so it won't be clipped by table scroll
                        ...
                        // Toggle + position dropdown under the filter icon
        ...
        $(document).ready(function() {
            ...
            $('#NEW_CATEGORY_CREATE_FORM').on('submit', function(e) {
                e.preventDefault();


                $('#NEW_CATEGORY_CREATE_FORM_BTN').html('<button class="btn btn-primary w-100" disabled"><i class="bx bx-loader bx-spin"></i> VERIFYING..</button>');
                    ...
                    success: function(data) {
                        ...
                        if (data.success) {
                            Swal.fire('Success!', data.success, 'success').then(() => {
                                ...
                                document.querySelector('#add_new_category_modal .btn[data-bs-dismiss="modal"]').click();
                                get_table_data();
                                $('#NEW_CATEGORY_CREATE_FORM_BTN').html('<button class="btn btn-primary w-100" type="submit">SAVE</button>');
                            });
                        } else if (data.error) {
