                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">PRODUCT DESTROY RETURNED APPROVALS</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                            ...
                            <div class="card">
                                <div class="card-header bg-transparent border-bottom">
                                    <div class="d-flex flex-wrap align-items-start">
                                        <div class="me-2">
                                            <h5 class="card-title mt-1 mb-0 text-primary">RETURNED FILTER</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4">
                                            <div class="card d-flex flex-row align-items-center border shadow-none mt-3">
                                                ...
                                                <div class="ms-3">
                                                    <p class="text-muted mb-2">RETURNED COUNT</p>
                                                    <h5 class="mb-0">
