                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">DESTROY REQUESTS</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                            ...
                            <div class="card">
                                <div class="card-header bg-transparent border-bottom">
                                    <div class="d-flex flex-wrap align-items-start">
                                        <div class="me-2">
                                            <h5 class="card-title mt-1 mb-0 text-primary">REQUESTS FILTER</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form id="ORDER_MANAGE_FILTER_FORM">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 mt-2">
                                                <label for="">destroy_request_approvals CODE</label>
...
<script>
    $(document).ready(function() {
        ...
        $('#ORDER_MANAGE_FILTER_FORM').on('submit', function(e) {
            ...
            $.ajax({
                url: "{{url('/')}}/get_destroy_request_filter_result",
                type: "POST",
                data: formData,
                dataType: 'json',
