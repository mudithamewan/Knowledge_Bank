                            ...
                            <div class="card">
                                <div class="card-header bg-transparent border-bottom">
                                    <div class="d-flex flex-wrap align-items-start">
                                        <div class="me-2">
                                            <h5 class="card-title mt-1 mb-0 text-primary">STOCK FILTER</h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <form id="STOCK_FILTER_FORM">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2 mt-2">
                                                <div id="STOCK_FILTER_FORM_BTN" style="margin-top: 27px;">
...
<script>
    $(document).ready(function() {
        ...
        $('#STOCK_FILTER_FORM').on('submit', function(e) {
            e.preventDefault();
            $('#STOCK_FILTER_FORM_BTN').html('<button class="btn btn-primary w-100" disabled><i class="bx bx-loader bx-spin font-size-16 align-middle me-2"></i> VERIFYING..</button>');

            e.preventDefault();
            var formData = $(this).serialize();

            $.ajax({
                url: "{{url('/')}}/get_stock_filter_result",
                type: "POST",
                data: formData,
                dataType: 'json',
                success: function(data) {
                    ...
                    if (data.result) {
                        $('#STOCK_FILTER_FORM_BTN').html('<button class="btn btn-primary w-100" type="submit">GET RESULT</button>');
    ...
    $(document).ready(function() {
        ...
        $('#STOCK_FILTER_FORM button[type="submit"]').trigger('click');
    });
</script>