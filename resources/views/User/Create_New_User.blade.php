                            ...
                            <form id="NEW_USER_CREATE_FORM">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 mt-2">
                                        ...
                                        <input type="text" name="ADDRESS_LINE_01" id="ADDRESS_LINE_01" class="form-control" required>
                                    </div>
                                    <div class="col-lg-3 mt-2">
                                        <label for="">ADDRESS LINE 02</label>
                                        <input type="text" name="ADDRESS_LINE_02" id="ADDRESS_LINE_02" class="form-control">
                                    </div>
                                    <div class="col-lg-3 mt-2">
                                        <label for="">ADDRESS LINE 03</label>
                                        <input type="text" name="ADDRESS_LINE_03" id="ADDRESS_LINE_03" class="form-control">
                                    </div>
                    ...
                    if (data.success) {
                        Swal.fire(
                            ...
                            if (result.isConfirmed) {
                                window.location.assign("{{url('/')}}/User_Profile/" + encodeURIComponent(btoa(data.user_id)));
                            } else {
                                window.location.assign("{{url('/')}}/User_Profile/" + encodeURIComponent(btoa(data.user_id)));
                            }
                        });
