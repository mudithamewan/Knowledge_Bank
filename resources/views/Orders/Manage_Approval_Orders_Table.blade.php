...
<div class="card">
    <div class="card-header bg-transparent border-bottom">
        <div class="d-flex flex-wrap align-items-start">
            <div class="me-2">
                <h5 class="card-title mt-2 text-primary">ORDER DETAILS</h5>
            </div>
            <div class="ms-auto">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="result_table" class="table table-sm">
                <thead>
                    <tr>
                        <th style="white-space: nowrap;">ORDER CODE <span class="filter-icon"><i class="bx bx-filter"></i></span></th>
                        <th style="white-space: nowrap;">ORDER STAGE <span class="filter-icon"><i class="bx bx-filter"></i></span></th>
                        <th style="white-space: nowrap;">ORDER DATE <span class="filter-icon"><i class="bx bx-filter"></i></span></th>
                        <th style="white-space: nowrap;">ORDER BY <span class="filter-icon"><i class="bx bx-filter"></i></span></th>
                        <th style="white-space: nowrap;">CUSTOMER COUNT <span class="filter-icon"><i class="bx bx-filter"></i></span></th>
    ...
    function get_table_data() {
        ...
        var table = $('#result_table').DataTable({
            ...
            ajax: {
                ...
                url: "{{url('/')}}/get_approval_order_filter_result_table",
                data: {
                    FROM_DATE: '{{$FROM_DATE}}',
                    TO_DATE: '{{$TO_DATE}}',
                    OR_ID: '{{$OR_ID}}',
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(d) {
                        const baseUrl = "{{ url('/') }}";
                        return `
                            <a href="${baseUrl}/Order_View/${encodeURIComponent(btoa(d))}"
            ...
            initComplete: function() {
                ...
                $('#result_table thead th').each(function(i) {
                    ...
                    // attach dropdown to body so it's not clipped by scroll container
