...
<div class="invoice_content">
    <table width="100%" style="border-bottom: 1px solid #292561; padding-bottom:5px;">
        <tr>
            <td width="50%" style="vertical-align: top; text-align: left; font-size: 25px; color:#292561; font-weight:bold;">INVOICE</td>
    ...
    <div class="tbl">
        <table width="100%">
            ...
            <tr style="font-size: 12px;">
                ...
                <td style="text-align: right;">{{number_format($data->ini_selling_price,2)}}</td>
                <td style="text-align: center;">{{$data->ini_qty}}</td>
                <td style="text-align: right;">{{number_format(($data->ini_selling_price * $data->ini_qty),2)}}</td>
                <td style="text-align: right;">{{$data->ini_discount_percentage}}</td>
                <td style="text-align: right;">{{number_format(($data->ini_final_price * $data->ini_qty),2)}}</td>
            </tr>
            @endforeach
        </table>
    </div>
                ...
                <div class="tbl">
                    <table width="100%">
                        <tr>
                            ...
                            <td style="text-align: right;">{{number_format($INVOICE_DATA->in_sub_total,2)}}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th style="color:#292561">PAID</th>
                            <td style="text-align: right;">{{number_format($INVOICE_DATA->in_total_paid_amount,2)}}</td>
                        </tr>
                        <tr>
                            <th style="color:#292561">BALANCE</th>
                            <td style="text-align: right;">{{number_format($INVOICE_DATA->in_total_balance,2)}}</td>
                        </tr>
                    </table>
                </div>
            </td>
